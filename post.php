 ...
 ?>
    ...
    while(mysqli_stmt_fetch($stmt)) {
        ...
        ?>
                ...
                <p class="lead">
                    by <a href="/../cms/index"><?php echo $post_user ?></a>
                </p>
        ...
        ?>
           ...
           <?php
              ...
              <?php  } else { ?>
                    ...
                    <div class="row">
                        <p class="pull-right login-to-post">Musisz się zalogować  <a href="/cms/login.php">(Zaloguj się) </a> żeby polubić ofertę. </p>
                    </div>
